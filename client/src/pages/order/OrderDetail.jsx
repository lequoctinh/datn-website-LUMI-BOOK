...
import { 
  ...
  faCheckCircle, faTimesCircle, faClock, faReceipt, faStar, faPenNib
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="px-8 py-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="text-xs font-bold text-blue-600 uppercase tracking-widest mb-1">Chi tiết đơn hàng</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div key={index} className="py-6 flex gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start mb-1">
                          <h4 className="font-bold text-gray-900 hover:text-blue-600 transition-colors cursor-pointer line-clamp-1">{item.ten_sach}</h4>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <FontAwesomeIcon icon={faShoppingBag} /> Quay về trang chủ
                  </button>
                </div>
              </div>
            </div>
        ...
        <p className="text-center mt-12 text-gray-400 text-xs">
          Cảm ơn bạn đã mua sắm tại Lumi Book. Mọi thắc mắc vui lòng liên hệ bộ phận hỗ trợ 24/7.
        </p>
      </div>
    </div>
  );

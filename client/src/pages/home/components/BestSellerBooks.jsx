...
return (
    ...
    <div className="w-full max-w-[1200px] px-4">
        ...
        {bestSellers.map((book) => (
            <div key={book.id} className="lumi-card group relative rounded-xl p-5 border border-border-light cursor-pointer h-[460px] flex flex-col items-center">
            ...
            <div className="flex flex-col w-full text-center flex-grow z-30">
                ...
                <button className="btn-add-cart w-10 h-10 rounded-lg border border-brand-light text-brand-primary flex items-center justify-center bg-transparent">

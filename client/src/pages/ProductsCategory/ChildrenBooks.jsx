...
const ChildrenBooks = () => {
    ...
    const handleCategoryClick = (id) => {
        if (id === CHILDREN_CATEGORY_ID) return;
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end gap-6">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-text-muted text-lg font-light leading-relaxed">
                                Khám phá thế giới kỳ diệu qua những trang sách đầy màu sắc, giúp bé phát triển tư duy và bồi dưỡng tâm hồn.
                            </p>
                        </div>
                                        ...
                                        >
                                            ...
                                            <FontAwesomeIcon 
                                                ...
                                                className={`text-[10px] transition-transform duration-300 ${
                                                    cat.id === CHILDREN_CATEGORY_ID ? 'translate-x-0' : '-translate-x-2 opacity-0 group-hover:translate-x-0 group-hover:opacity-100'
                                                }`} 
                                            />
                                        </button>
                                    ))}
